...
public boolean isBanking = false;//Glitch stopper by mikee :)
...
public boolean usingMorrJavs = false;
...
public int[] clawDamage = { 0, 0, 0 };
	...
	public void initialize() {
		synchronized (this) {
			...
			sendMessage("@bla@Welcome to Fallen Pkers");
			sendMessage("@bla@Only donate to Gian or 50percentelf if gian isnt around.");
			sendMessage("@whi@ ::pits for safe competition");
			sendMessage("@whi@ Out of money? Try out ::monsters to gain some cash!");
			sendMessage("@whi@ ::barrows to get barrows armor. Get a spade from fairy and kill all bosses then go tunnel");
			sendMessage("@red@Super donor commands are ::Claws ::Chaoticlongsword ::chaoticstaff");
			sendMessage("@red@ ::chaoticrapier ::chaoticmaul");
			sendMessage("@yel@ Fuck all the Elf haters, you can smfd, fags.");
