...
public class ActionHandler {
	...
	public void firstClickObject(int objectType, int obX, int obY) {
		...
		break;
		case 2562:
			c.getThieving().stealFromStall(995, 25000, 80, 80);
		break;
		case 9299:
			if (c.absY <= 3190) {
					c.getPA().walkTo(0, 1);
		...
		case 2640:
			...
			if(c.specAmount < 10.0){
				...
				c.sendMessage("Your special attack has been restored, only every 360 seconds.");
			}
			break;
		case 2873:
		...
		case 1815:
			c.getPA().startTeleport2(3086, 3483, 0);
		break;
